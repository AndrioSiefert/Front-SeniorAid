import ArrowPage from "@/_components/ArrowPage/ArrowPage";
    ...
    return (
        <div>
            ...
            <div className="relative flex flex-col items-center py-4 bg-colorPageInfo3 text-white">
                <h2 className="text-xl font-bold mb-2 z-10">
                    VEJA COMO FUNCIONA PARA CUIDADORES
                </h2>
                <div className="absolute bottom-[-30px] ">
                    <IoTriangleSharp
                        size={50}
                        className=" rotate-180 text-colorPageInfo3"
                    />
                </div>
            </div>
